        ...
        @can('viewLeaderBoard', App\Models\User::class)
            ...
            <div class="flex justify-center py-6 gap-8 mb-10">
                <a href="{{ route('register') }}"
                    class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 px-8 rounded-lg transition-all shadow-lg transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-300">
                    Register Now
                </a>
                <a href="{{ route('login') }}"
                    class="bg-white hover:bg-gray-50 text-blue-600 font-semibold py-4 px-8 rounded-lg border-2 border-blue-600 transition-all focus:outline-none focus:ring-2 focus:ring-blue-300">
                    Login
                </a>
            </div>
        @endcan
